...
public interface ICmsApiClient
{
    ...
    Task<PaymentModel> EnsurePayOnDeliveryPaymentAsync(Guid pharmacyId, CreatePaymentRequest request, CancellationToken cancellationToken = default);
    ...
    Task UpdatePaymentStatusAsync(Guid pharmacyId, Guid paymentId, UpdatePaymentStatusRequest request, CancellationToken cancellationToken = default);
