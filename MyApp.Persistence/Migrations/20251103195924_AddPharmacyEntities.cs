...
IF OBJECT_ID(N'[dbo].[T_TodoItems]', N'U') IS NULL
BEGIN
    CREATE TABLE [dbo].[T_TodoItems] (
        [Id] INT IDENTITY(1,1) NOT NULL,
        [Title] NVARCHAR(200) NOT NULL,
        CONSTRAINT [PK_T_TodoItems] PRIMARY KEY ([Id])
    );
END
");
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Categories_Pharmacies_PharmacyId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Categories_PharmacyId_Name",
                table: "Categories",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Orders_PharmacyId_OrderNumber",
                table: "Orders",
                columns: new[] { "PharmacyId", "OrderNumber" },
                unique: true);

            migrationBuilder.CreateIndex(
                name: "IX_Products_PharmacyId_Name",
                table: "Products",
                columns: new[] { "PharmacyId", "Name" },
                unique: true);
        }
        ...
        protected override void Down(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.Sql(@"
IF OBJECT_ID(N'[dbo].[T_TodoItems]', N'U') IS NOT NULL
BEGIN
    DROP TABLE [dbo].[T_TodoItems];
END
");
